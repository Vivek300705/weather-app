            ...
            <div className="flex flex-wrap justify-center gap-6">
                {news.length > 0 ? (
                    news.map((article, index) => (
                        <div
                            key={index}
                            className="bg-white border border-gray-200 rounded-lg overflow-hidden shadow-lg transform transition duration-300 hover:scale-105 flex flex-col w-auto h-[220px] relative"
                        >
                            {/* Image Section - Absolute Positioning */}
                            <img
                                style={{ width: "auto", height: "100px" }} // Height set to 100px, width auto
