...
const News = () => {
    ...
    return (
        <div className="p-6 bg-gray-100">
            ...
            <div className="p-6">
            <div className="flex flex-wrap justify-center gap-6 px-7 mx-7">
                {news.length > 0 ? (
                    news.map((article, index) => (
                        <div
                            key={index}
                            style={{ width: "30%",padding: "22px"}}
                            className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 px-7 mx-7"
                        >
                            {/* Image Section */}
                            <img
